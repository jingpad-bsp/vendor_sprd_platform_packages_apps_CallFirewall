...
public class CallFireWallActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mContext = this;
        /* SPRD: modify for bug501393 & 611535 @{*/
    ...
    protected void onDestroy() {
        ...
        if (mBlackFragment != null) {
            mBlackFragment.dismissDialog();
        }
        if (mCallLogFragment != null) {
            mCallLogFragment.dismissDialog();
        }
        if (mSmsFragment != null) {
            mSmsFragment.dismissDialog();
        }
        /* @} */
        // SPRD: add for bug 721519
    ...
    private PhoneStateListener mPhoneStateListener = new PhoneStateListener() {
        public void onCallStateChanged(int state, String incomingNumber) {
            Log.d(TAG, "onCallStateChanged: num = " + incomingNumber);
            if (PhoneNumberUtils.isEmergencyNumber(incomingNumber)) {
                new BlockSuppressionStatusTask().execute();
            }
        }
    };
    ...
    private class BlockSuppressionStatusTask extends AsyncTask<Void, Void, BlockSuppressionStatus> {
        ...
        protected void onPostExecute(BlockSuppressionStatus blockSuppressionStatus) {
            /* SPRD: modify for bug 721519 @{ */
            Log.d(TAG, "onPostExecute: " + isResumed());
            if (blockSuppressionStatus != null) {
